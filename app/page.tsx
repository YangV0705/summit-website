...
//       <section className="border-b border-[#eee4d1] bg-[#f8f6f1]">
//         <div className="mx-auto grid max-w-7xl gap-10 px-6 py-20 md:grid-cols-2 md:items-center md:py-28">
//           {/* 左边：文字 + 图片 */}
//           <div className="relative overflow-hidden rounded-[32px] min-h-[620px] border border-[#eadfc8]">
//             <img
//               src="/hero.jpg"
...
//             <div className="absolute inset-0 bg-[#f8f6f1]/78" />
//             <div className="absolute inset-0 bg-gradient-to-r from-[#f8f6f1]/95 via-[#f8f6f1]/82 to-[#f8f6f1]/60" />
...
//               <p className="mb-8 max-w-2xl text-lg leading-8 text-[#10233f]/78">
//                 {content.heroDesc}
//               </p>
...
//                 <Link
//                   href="/services"
//                   className="rounded-full border border-[#c9a24a] bg-white/70 px-8 py-3 text-sm font-bold text-[#c9a24a] transition hover:bg-[#c9a24a] hover:text-[#10233f]"
//                 >
...
//               {lang === "zh" ? "为什么选择我们" : "Why Choose Summit"}
//             </p>

//             <h2 className="mb-6 text-3xl font-semibold leading-tight tracking-tight">
//               {lang === "zh"
//                 ? "以专业、清晰与关怀为基础的支持"
//                 : "Support Built on Professionalism, Clarity, and Care"}
//             </h2>

//             <p className="mb-8 leading-8 text-[#10233f]/72">
//               {lang === "zh"
//                 ? "我们希望用更清楚的沟通、更有条理的准备，以及更贴近客户情况的方式，为每一位客户提供真正有帮助的移民与留学支持。"
//                 : "We aim to provide immigration and education support through clearer communication, more organized preparation, and a more thoughtful understanding of each client’s situation."}
//             </p>
...
//                     "Based in Burnaby, BC",
//                     "Thoughtful communication and service detail",
//                   ]
//               ).map((item) => (
//                 <div
//                   key={item}
//                   className="rounded-2xl border border-[#f1e8d6] bg-[#fcfbf8] px-5 py-4 text-base font-medium text-[#10233f]/80"
//                 >
//                   {item}
//                 </div>
//               ))}
...
//         heroRightTag: "为什么选择我们",
//         heroRightTitle: "以清晰与关怀为基础的支持",
//         heroRightDesc:
//           "我们希望用更清楚的沟通、更有条理的准备，以及更贴近客户情况的方式，为每一位客户提供真正有帮助的移民与留学支持。",
//         heroRightPoints: [
//           "中英双语支持",
...
//       heroRightTag: "Why Choose Summit",
//       heroRightTitle: "Support Built on Clarity and Care",
//       heroRightDesc:
//         "We aim to provide immigration and education support through clearer communication, more organized preparation, and a more thoughtful understanding of each client’s situation.",
//       heroRightPoints: [
//         "Chinese and English support",
...
//       <section className="border-b border-[#eee4d1] bg-[#f8f6f1]">
//         {/* <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-2 md:items-stretch md:py-20"> */}
//           <div className="mx-auto grid max-w-7xl gap-8 px-6 py-14 md:grid-cols-[1.08fr_0.92fr] md:items-start md:py-20 lg:gap-10">
//           <div className="relative overflow-hidden rounded-[32px] min-h-[560px] border border-[#eadfc8]">
//             <img
//               src="/hero.jpg"
//               alt="Vancouver skyline"
//               className="absolute inset-0 h-full w-full object-cover"
...
//           {/* <div className="flex flex-col justify-center rounded-[32px] border border-[#eadfc8] bg-white p-8 shadow-[0_20px_60px_rgba(16,35,63,0.08)] md:min-h-[560px]"> */}
//           <div className="rounded-[32px] border border-[#eadfc8] bg-white p-8 shadow-[0_20px_60px_rgba(16,35,63,0.06)] md:p-9">
//             <p className="mb-3 text-sm font-semibold uppercase tracking-[0.28em] text-[#c9a24a]">
//               {content.heroRightTag}
//             </p>

//             {/* <h2 className="mb-6 text-3xl font-semibold leading-tight tracking-tight"> */}
//             <h2 className="mb-5 text-3xl font-semibold leading-[1.12] tracking-tight">
//               {content.heroRightTitle}
//             </h2>

//             {/* <p className="mb-8 leading-8 text-[#10233f]/72"> */}
//             <p className="mb-6 text-base leading-8 text-[#10233f]/72">
//               {content.heroRightDesc}
//             </p>

//             <div className="grid gap-3">
//               {content.heroRightPoints.map((item) => (
//                 <div
//                   key={item}
//                   // className="rounded-2xl border border-[#f1e8d6] bg-[#fcfbf8] px-5 py-4 text-base font-medium text-[#10233f]/80"
//                   className="rounded-2xl border border-[#f1e8d6] bg-[#fcfbf8] px-5 py-3.5 text-[15px] font-medium leading-7 text-[#10233f]/78"
//                 >
//                   {item}
//                 </div>
//               ))}
      ...
      <section className="border-b border-[#eee4d1] bg-[#f8f6f1]">
        <div className="mx-auto grid max-w-7xl gap-8 px-6 py-14 md:grid-cols-[1.08fr_0.92fr] md:items-start md:py-20 lg:gap-10">
          <div className="relative overflow-hidden rounded-[32px] min-h-[560px] border border-[#eadfc8]">
            ...
            <div className="absolute inset-0 bg-[#f8f6f1]/80" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#f8f6f1]/96 via-[#f8f6f1]/84 to-[#f8f6f1]/62" />

            <div className="relative z-10 flex h-full flex-col justify-center p-8 md:p-10 lg:p-12">
              <p className="mb-5 text-sm font-semibold uppercase tracking-[0.28em] text-[#c9a24a]">
                {content.heroTag}
              </p>

              <h1 className="mb-6 max-w-4xl text-5xl font-semibold leading-[0.98] tracking-tight md:text-6xl lg:text-7xl">
                {content.heroTitle[0]}
                <br />
                {content.heroTitle[1]}
                <br />
              ...
              <p className="mb-9 max-w-2xl text-base leading-8 text-[#10233f]/76 md:text-lg">
                {content.heroDesc}
              </p>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {content.trustItems.map((item) => (
              <div
                ...
                className="rounded-3xl border border-[#eee4d1] bg-[#f8f6f1] p-8"
              >
                <h3 className="mb-4 text-xl font-semibold leading-snug text-[#10233f] md:text-2xl">
                  {item.title}
                </h3>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 flex flex-col gap-5 md:mb-12 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="text-3xl font-semibold tracking-tight text-[#10233f] md:text-4xl">
                {content.servicesTitle}
              </h2>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {content.services.map((item, index) => (
              ...
              >
                ...
                <p className="max-w-xl text-[15px] leading-8 text-[#10233f]/70 md:text-base">
                  {item.desc}
                </p>
              </div>
            ))}
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {content.processSteps.map((item) => (
              ...
              >
                ...
                <p className="text-[15px] leading-8 text-white/78 md:text-base">
                  {item.desc}
                </p>
              </div>
            ))}
